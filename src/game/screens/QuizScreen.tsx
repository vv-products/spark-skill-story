    ...
    <div className="relative flex min-h-[100dvh] flex-col overflow-hidden bg-background">
      ...
      <main className="flex flex-1 flex-col px-4 pb-6">
        <div className="flex items-center justify-between">
          <div className="rounded-full bg-coral/15 px-3 py-1 text-xs font-extrabold text-coral ring-1 ring-coral/30">
            ⚡ Rapid Fire
          </div>
          <div className="rounded-full bg-foreground px-3 py-1 text-xs font-extrabold text-background tabular-nums">
        ...
        <div className="mt-3 h-2 overflow-hidden rounded-full bg-muted">
          <div
            className="h-full rounded-full bg-gradient-to-r from-sage to-coral transition-[width] duration-100"
            style={{ width: `${timePct}%` }}
          />
        </div>
        ...
        <div className="mt-8 flex flex-1 items-center justify-center">
          <div className="animate-bounce-in rounded-3xl bg-card px-6 py-8 text-center shadow-pop" key={idx}>
            <p className="text-[11px] font-bold uppercase tracking-widest text-muted-foreground">True or False?</p>
        ...
        <div className="grid grid-cols-2 gap-3 pt-6">
          <button
            disabled={locked}
            onClick={() => handle(true)}
            className="group relative flex h-44 flex-col items-center justify-center gap-2 rounded-3xl bg-sage text-sage-foreground shadow-pop transition-all active:scale-95 disabled:opacity-60"
          >
          ...
          <button
            ...
            className="group relative flex h-44 flex-col items-center justify-center gap-2 rounded-3xl bg-coral text-coral-foreground shadow-pop transition-all active:scale-95 disabled:opacity-60"
          >
