...
export function EmotionsCrossword({ initialCode }: { initialCode?: string }) {
  ...
  const mergedScores: Record<string, Score> = { ...scores, [myName]: scores[myName] ?? { name: myName, correctLetters: 0, correctWords: 0 } };
  const scoreList: Score[] = Object.values(mergedScores)
